...
<h1 align="center" >Dhanekula Student Feedback System</h1><br><br>
		...
		if(isset($_POST['submit'])){
			...
			$query = mysqli_query($connect," SELECT subject FROM faculty_teach WHERE year=$year AND sec='$sec' AND sem=$sem and dept='$dept' AND batch=$batch AND course='$course' AND elective=$elective") or die("cannot process query");
